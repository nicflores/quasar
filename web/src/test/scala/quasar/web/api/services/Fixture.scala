...
package quasar.web.api.services
...
import quasar.web.api.{FailedResponseOr, FailedResponseT}
import quasar.web.api.JsonFormat.{SingleArray, LineDelimited}
import quasar.web.api.JsonPrecision.{Precise, Readable}
import quasar.web.api.MessageFormat.JsonContentType
